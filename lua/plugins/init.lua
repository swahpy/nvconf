return {
...

  {
    ...
    keys = {
      ...
      { "<leader>fi", [[<cmd> Lspsaga finder imp <cr>]], desc = "Lspsaga finder implementation" },
      { "<leader>fr", [[<cmd> Lspsaga finder ref <cr>]], desc = "Lspsaga finder references" },
      { "<leader>fd", [[<cmd> Lspsaga finder def <cr>]], desc = "Lspsaga finder definition" },
